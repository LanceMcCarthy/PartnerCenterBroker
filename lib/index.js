...
class DevCenter {
    constructor(_tenantId, _clientId, _clientSecret) {
        if (_tenantId == null || _clientId == null || _clientSecret) {
            throw new Error('You must pass a valid Tenent ID, Client ID and Client Secret. See the documentation for exampls and guiance https://lancemccarthy.github.io/PartnerCenterBroker/.');
        }
